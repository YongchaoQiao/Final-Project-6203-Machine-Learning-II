...
# %% ----------------------------------- Hyper Parameters --------------------------------------------------------------
LR = 0.1  # 0.15 0.1 0.01
N_EPOCHS = 300
BATCH_SIZE = 412  # 200, 412, 430(Max memory)
DROPOUT1 = 0.8
DROPOUT2 = 0.7
patience = 120
...
model.apply(weights_init_4)  # weights_ini_1 weights_ini_2 weights_ini_3 weights_ini_4
...
best_model_AUC = None
counter = 0
PATH = 'model_yongchaoqiao9final.pt'
...
for epoch in range(N_EPOCHS):
    ...
    if best_model_AUC is None:
        ...
        print(f'Validation loss decreased ({0:.6f} --> {best_model_AUC:.6f}).  Saving model as ' + '\"' + PATH +
              '\"')
